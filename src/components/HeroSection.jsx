...
const containerVariants = {
  hidden: { opacity: 0 },
  visible: { opacity: 1, transition: { straggerChildern: 0.2 } },
};
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 flex flex-col items-center text-center">
        ...
        <motion.h1
          variants={fadeInUp}
          className="text-5xl lg:text-8xl my-4 font-semibold tracking-tighter bg-linear-to-b from-neutral-50 via-neutral-300 to-neutral-700 bg-clip-text text-transparent"
        >
          The Ultimate <span className="flex">Streaming Toolkit+</span>
        </motion.h1>
        ...
        <motion.div variants={fadeIn} className="p-10">
